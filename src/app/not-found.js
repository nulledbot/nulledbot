    ...
    return (
        <div className="flex flex-col items-center justify-center text-center min-h-screen">
            <Link href={'/'} className="hover:scale-110 transition-transform duration-300">
                <svg
                    viewBox="2500 2500 2500 2500"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-[50px] h-[50px] overflow-visible"
                >
                    <path
                        ref={pathRef}
            ...
            <h1
                ref={titleRef}
                className="ml-5 xl:ml-8 text-2xl text-[#e50007] mt-10 font-bold opacity-0"
            >
                {code}
            </h1>
        </div>
